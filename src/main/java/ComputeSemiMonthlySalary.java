...
public class ComputeSemiMonthlySalary {
    public static void main(String[] args) {
        ...
        // Compute gross semi-monthly rate (half of monthly salary + half of allowances)
        ...
        if (grossSemiMonthlyRate <= 0) {
            ...
            System.out.println("Gross Semi-Monthly Rate: PHP " + String.format("%.2f", grossSemiMonthlyRate));
    ...
    // PhilHealth contribution (3% of monthly salary, capped, employee share = 50%)
    ...
    // Pag-IBIG contribution (1% if 1,000–1,500, 2% if >1,500, capped at 100)
